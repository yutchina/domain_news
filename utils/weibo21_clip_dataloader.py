...
class bert_data():
    ...
    def load_data(self,path,imagepath,clipimagepath,shuffle,text_only = False):
        ...
        print("token_ids",token_ids.size())#torch.Size([4927, 197])
        print("masks", masks.size())#torch.Size([4927, 197])
        print("label", label.size())#torch.Size([4927])
        print("category", category.size())#torch.Size([4927])
        print("ordered_image", ordered_image.size())#torch.Size([4926, 3, 224, 224])
        print("clip_image", clip_image.size())#torch.Size([4926, 3, 224, 224])
        print("clip_text", clip_text.size())#torch.Size([4927, 52])
